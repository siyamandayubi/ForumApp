    ...
    private static Preference.OnPreferenceChangeListener sBindPreferenceSummaryToValueListener = new Preference.OnPreferenceChangeListener() {
        ...
        public boolean onPreferenceChange(Preference preference, Object value) {
            ...
            if (preference instanceof ListPreference) {
				...
				if (preference.getKey().equals(SessionManager.SERVER_ROOT_ADDRESS)){
					SessionManager sessionManager = new SessionManager(preference.getContext());
					String baseAddress = sessionManager.getBaseAddress();
					if (baseAddress != null && stringValue != null && !stringValue.equalsIgnoreCase(baseAddress)) {
                        sessionManager.clearServerRelatedData();
                    }
				}
            }
            return true;
	...
	*/
    ...
    protected boolean isValidFragment(String fragmentName) {
        return PreferenceFragment.class.getName().equals(fragmentName)
                ...
                || ServerSettingsFragment.class.getName().equals(fragmentName);
    ...
    public static class ServerSettingsFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            bindPreferenceSummaryToValue(findPreference(SessionManager.SERVER_ROOT_ADDRESS));
        }
